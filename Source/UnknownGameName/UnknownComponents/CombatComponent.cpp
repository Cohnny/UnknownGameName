...
#include "UnknownGameName/Character/UnknownAnimInstance.h"
#include "UnknownGameName/Weapon/Projectile.h"
#include "UnknownGameName/Weapon/Shotgun.h"
...
void UCombatComponent::SetHUDCrosshairs(float DeltaTime)
{
	...
	if (Controller)
	{
		HUD = HUD == nullptr ? Cast<AUnknownHUD>(Controller->GetHUD()) : HUD;
		if (HUD)
		{
			if (EquippedWeapon)
			{
...
void UCombatComponent::IntitializeCarriedAmmo()
{
